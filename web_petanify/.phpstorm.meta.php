...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.Y:\web_petanify\public\storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.Y:\\web_petanify\\public\\storage','logging.default','logging.deprecations.channel',
...
'livewire.update','livewire.upload-file','livewire.preview-file','dashboard','profile.edit','profile.update',
'profile.destroy','petani.dashboard','petani.forum.index','petani.post.store','petani.comment.store',
'petani.forum.show','petani.marketplace.index','petani.produk.show','petani.petani.produk.show','petani.petani.marketplace.index',
'petani.keranjang','petani.keranjang.update','petani.cart.add','pembeli.dashboard','pembeli.forum.index',
'pembeli.post.store','pembeli.comment.store','admin.dashboard','admin.forum.index','admin.post.store',
'admin.post.delete','admin.post.manage','admin.comment.manage','admin.comment.delete','admin.kategori.index',
'admin.kategori.create','admin.kategori.store','admin.kategori.show','admin.kategori.edit','admin.kategori.update',
'admin.kategori.destroy','admin.produk.index','admin.produk.create','admin.produk.store','admin.produk.edit',
'admin.produk.update','admin.produk.destroy','register','login','password.request','password.email','password.reset','password.store',
'verification.notice','verification.verify','verification.send','password.confirm',
'password.update','logout','storage.local',);
        registerArgumentsSet('views', 
'admin.dashboard','admin.forum.comments','admin.forum.index','admin.forum.posts','admin.forum.show',
'admin.kategori.create','admin.kategori.edit','admin.kategori.index','admin.marketplace.create','admin.marketplace.edit',
'admin.marketplace.index','admin.partials.sidebar','auth.confirm-password','auth.forgot-password','auth.login',
'auth.register','auth.reset-password','auth.verify-email','components.application-logo','components.auth-session-status',
'components.danger-button','components.dropdown','components.dropdown-link','components.emoji-btn','components.input-error',
'components.input-label','components.modal','components.nav-link','components.primary-button','components.responsive-nav-link',
'components.secondary-button','components.text-input','dashboard','footer','layouts.admin',
'layouts.app','layouts.guest','layouts.navigation','livewire.comment-section','livewire.forum-post-list',
'pembeli.dashboard','pembeli.forum.index','pembeli.forum.show','petani.dashboard','petani.forum.index',
'petani.forum.show','petani.keranjang.index','petani.marketplace.index','petani.produk.show','profile.edit',
