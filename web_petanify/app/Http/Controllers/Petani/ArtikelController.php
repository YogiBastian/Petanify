...
class ArtikelController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('Petani.artikel.index', compact('artikels', 'slideshowArtikels', 'rekomendasiArtikels'));
    }
    ...
    public function show($id)
    {
        ...
        return view('Petani.artikel.show', compact('artikel', 'relatedArtikels'));
    }
}
