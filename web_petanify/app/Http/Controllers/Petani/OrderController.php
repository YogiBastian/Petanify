...
class OrderController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('petani.orders.index', compact('orders', 'status'));
    }
    ...
    public function bayarForm($orderId)
    {
        ...
        return view('petani.orders.bayar', compact('order', 'banks'));
    }
    ...
    public function uploadBukti(Request $request, $orderId)
    {
        ...
        return redirect()->route('petani.orders.index')->with('success', 'Bukti transfer berhasil diupload. Tunggu verifikasi admin.');
    }
