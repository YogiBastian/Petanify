<x-app-layout>
    ...
    <div class="py-6 forum-wrapper">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 forum-main">
            ...
            <!-- Posting Form -->
            <form method="POST" action="{{ route('petani.post.store') }}" enctype="multipart/form-data" class="forum-post-form">
                @csrf
            ...
            @foreach($posts as $post)
                <div class="forum-post-card">
                    <div class="forum-post-header">
                        ...
                        <img
                            src="{{ $post->user->foto
                                ? asset('storage/foto_profil/' . $post->user->foto)
