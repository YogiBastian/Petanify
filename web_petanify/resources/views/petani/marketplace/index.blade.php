<x-app-layout>
    ...
    <div class="w-full bg-white py-3 shadow-sm border-b">
        <div class="max-w-7xl mx-auto flex items-center gap-2 px-4">
            <form class="flex-1 flex" action="{{ route('petani.marketplace.index') }}" method="GET">
        ...
        <aside class="marketplace-sidebar" style="background: #f8f8f8;">
            ...
            <ul style="list-style:none;padding:0 0 12px 0;margin:0 0 28px 0;">
                <li style="margin-bottom:8px;">
                    <a href="{{ route('petani.marketplace.index') }}"
                ...
                @foreach($categories as $cat)
                    <li style="margin-bottom:8px;">
                        <a href="{{ route('petani.marketplace.index', ['kategori_id' => $cat->id]) }}"
        ...
        <main class="marketplace-content">
                ...
                <div>
                    ...
                    <div x-data="{ open: false }" class="relative">
                        ...
                        <div x-show="open" @click.away="open = false" x-transition
                            ...
                            <form id="sortForm" action="{{ route('petani.marketplace.index') }}" method="GET">
                                @if(request('search'))
            ...
            <div class="product-grid">
                @forelse($products as $product)
                    <a href="{{ route('petani.produk.show', $product->id) }}" class="product-card" style="text-decoration:none;">
