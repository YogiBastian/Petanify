...
<div class="max-w-2xl mx-auto py-8">
    ...
    <form action="{{ route('petani.orders.upload_bukti', $order->id) }}" method="POST" enctype="multipart/form-data" class="mb-6">
        @csrf
    ...
    <div>
        <a href="{{ route('petani.orders.index') }}" class="text-blue-600 underline">Kembali ke Riwayat Pesanan</a>
    </div>
</div>
</x-app-layout>
